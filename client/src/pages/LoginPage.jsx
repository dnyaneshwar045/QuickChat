...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#1e1c2e] flex items-center 
    justify-center sm:justify-evenly max-sm:flex-col p-4 backdrop-blur-xl text-white">
      ...
      className="border-2 bg-white/10 text-white border-gray-500 p-6 flex flex-col gap-6 
      rounded-lg shadow-lg " >
        <h2 className="font-medium text-2xl flex justify-between text-center ">
          {currState}
        ...
        {currState ==="Sign up" && !isDataSubmitted && (
          ...
          {!isDataSubmitted &&(
            ...
            type="email" placeholder='Email' required className='p-2 border border-gray-500 
...

          {
            currState === "Sign up" && isDataSubmitted && (
              ...
              row={4} className='p-2 border border-gray-500 
            rounded-md focus:outline-none focus:ring-2 
