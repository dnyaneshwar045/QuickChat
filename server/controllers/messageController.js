...
export const getUsersForSidebar = async(req, res)=>{
    try{
        ...
        // count number of the unseen message
...
// get all messagess for selected user
...
export const sendMessage = async(req, res) =>{
    try{
        ...
        //emit the new messge to the receiver socket
        const receiverSocketId = userSocketMap[receiverId];
        if(receiverSocketId){
            io.to(receiverSocketId).emit("newmessge", newMessage)
        }
